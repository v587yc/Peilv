...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 [&_button]:min-h-11 sm:flex-row sm:justify-end sm:[&_button]:min-h-9",
        className
      )}
      {...props}
    />
